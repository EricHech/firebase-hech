...
/**
 * This makes `appUser` a necessary part of Firebase Hech - it must be connected to everything that they want
 ...
 * * `appUser`:
 * This is now a Firebase Hech reserved name like `user` and must be public so that connections can be created between a user and
