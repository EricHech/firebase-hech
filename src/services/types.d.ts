...
export type User = StandardDataFields & Readonly<{
    uid: string;
    email?: string;
    phoneNumber?: string;
...
export type UpdateObject<T extends SoilDatabase = SoilDatabase, T2 extends keyof SoilDatabase = keyof SoilDatabase> = Record<string, T[T2] | null | boolean | number | string | object>;
...
export type ChangeDataKey<T2 extends keyof SoilDatabase, T22 extends keyof SoilDatabase> = Pick<CudDataParams<SoilDatabase, T2>, "update"> & {
    get: GetFunction;
    existingDataType: T2;
...
export type ModifyConnectionsType<T extends SoilDatabase, T2 extends keyof SoilDatabase> = Pick<CudDataParams<T, T2>, "update" | "updateObject" | "now" | "skipUpdate"> & {
    connections: {
